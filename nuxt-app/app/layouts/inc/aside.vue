    ...
    <aside class="sidebar">
        ...
        <div>
            <a href="index.php" class="sidebar-logo">
                ...
                <img src="#" alt="site logo" class="dark-logo">
                <img src="#" alt="site logo" class="logo-icon">
            </a>
        </div>
            ...
            <ul class="sidebar-menu" id="sidebar-menu">
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="index.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                AI</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="index-10.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                                POS & Inventory </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="wallet.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                Wallet</a>
                        </li>
                        <li>
                            <a href="marketplace.php"><i
                                    class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Marketplace</a>
                        </li>
                        <li>
                            <a href="marketplace-details.php"><i
                                    class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Marketplace
                                Details</a>
                        </li>
                        <li>
                            <a href="portfolio.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                                Portfolios</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="typography.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                Typography</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="pagination.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>
                                Pagination</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="star-rating.php"><i class="ri-circle-fill circle-icon text-indigo w-auto"></i> Star
                                Ratings</a>
                        </li>
                        <li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="form.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Input
                                Forms</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="wizard.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Form
                                Wizard</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="line-chart.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>
                                Line Chart</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="pie-chart.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i>
                                Pie Chart</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="users-list.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                Users List</a>
                        </li>
                        <li>
                            <a href="users-grid.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>
                                Users Grid</a>
                        </li>
                        <li>
                            <a href="add-user.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Add
                                User</a>
                        </li>
                        <li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="role-access.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                Role & Access</a>
                        </li>
                        <li>
                            <a href="assign-role.php"><i
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="blog.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>
                                Blog</a>
                        </li>
                        <li>
                            <a href="blog-details.php"><i
